  ...
  [3],
  {
                ...
                for (var b = 0, k = 0, w = []; k < p.length; ) {
                  ...
                  if (
                    ...
                    for (var S = 1; S <= E.length - 1; S++)
                      if ((w.push(E[S]), w.length === m)) return w;
                    k = b = x;
                  }
                }
        ...
        return [
          ...
          function (t, i) {
            ...
            for (var k, w = "", x = 0, E = 0; E < m.length; E++) {
              ...
              var A = b.groups;
              if (d) {
                var M = [S].concat(T, _, v);
                void 0 !== A && M.push(A);
                var j = String(i.apply(void 0, M));
              } else j = r(S, v, _, T, A, i);
              _ >= x && ((w += v.slice(x, _) + j), (x = _ + S.length));
            }
            return w + v.slice(x);
          },
        ];
    ...
    SNUk: function (t, e, n) {
      ...
      c ||
        ...
        X.prototype[R] || _(X.prototype, R, X.prototype.valueOf),
        C(X, "Symbol"),
        (M[Z] = !0);
    },
    SdaC: function (t, e, n) {
      ...
      t.exports = function (t, e, n, f, h, m, b) {
        ...
        if (
          ...
          if (
            ...
            for (x in w) (!d && !_ && x in T) || s(T, x, w[x]);
        ...
        u ||
          ...
          "function" == typeof z &&
            c(
              ...
              {
                fetch: function (t) {
                  return _(L, z.apply(s, arguments));
                },
              }
            ))),
      ...
      (r = function () {
        !(function (t) {
          ...
          var c = (function () {
            ...
            return (
              ...
              (e.prototype.runGuarded = function (t, e, n, r) {
                void 0 === e && (e = null), (P = { parent: P, zone: this });
                try {
                  try {
                    return this._zoneDelegate.invoke(this, t, e, n, r);
                  } catch (o) {
              ...
              (e.prototype.runTask = function (t, e, n) {
                ...
                if (t.state !== k || (t.type !== A && t.type !== O)) {
                  var r = t.state != E;
                  r && t._transitionTo(E, x), t.runCount++;
                  var o = I;
                  (I = t), (P = { parent: P, zone: this });
                  try {
                    t.type == O &&
                      t.data &&
                      !t.data.isPeriodic &&
                    ...
                    t.state !== k &&
                      ...
                      (t.type == A || (t.data && t.data.isPeriodic)
                        ? r && t._transitionTo(x, E)
                        : ((t.runCount = 0),
                          this._updateTaskCount(t, -1),
                          r && t._transitionTo(k, E, k))),
                      (P = P.parent),
                      (I = o);
                  }
                }
              ...
              function t(t, e, n) {
                (this._taskCounts = {
                  ...
                  (this._invokeTaskCurrZone =
                    n && (n.onInvokeTask ? this.zone : e._invokeTaskCurrZone)),
                  (this._cancelTaskZS =
                    n && (n.onCancelTask ? n : e._cancelTaskZS)),
                  (this._cancelTaskDlgt =
                    n && (n.onCancelTask ? e : e._cancelTaskDlgt)),
                  (this._cancelTaskCurrZone =
                    n && (n.onCancelTask ? this.zone : e._cancelTaskCurrZone)),
          ...
          var b = { name: "NO ZONE" },
            ...
            P = { parent: null, zone: new c(null, null) },
            I = null,
            D = 0;
          function C() {}
          ...
          Zone.__load_patch("ZoneAwarePromise", function (t, e, n) {
            ...
            function j(t, r, o) {
              ...
              if (t[g] === x) {
                ...
                if (
                  ...
                  I(o), j(t, o[g], o[y]);
                else if (r !== S && "function" == typeof s)
                  try {
                    s.call(o, u(T(t, r)), u(T(t, !1)));
                  } catch (d) {
                    u(function () {
                      j(t, !1, d);
                    })();
                  ...
                  if (
                    ((t[y] = o),
                    t[m] === m && r === E && ((t[g] = t[k]), (t[y] = t[b])),
                    r === S && o instanceof Error)
                  ) {
                    var p =
                      e.currentTask &&
                      e.currentTask.data &&
                  ...
                  var n,
                    ...
                    l = function (t) {
                      ...
                      try {
                        t.then(
                          function (t) {
                            (f[n] = e ? e.thenCallback(t) : t),
                              0 == --u && i(f);
                          },
                          function (t) {
                            e
                              ? ((f[n] = e.errorCallback(t)), 0 == --u && i(f))
                              : a(t);
                          }
                        );
                      } catch (r) {
            ...
            (Z && !Z.configurable) ||
              ...
              (Z.set = function (e) {
                e === C
                  ? (t[L] = e)
                  : ((t[u] = e), e.prototype[s] || z(e), n.setNativePromise(e));
              }),
              i(t, "Promise", Z)),
              (t.Promise = C);
            var R,
            ...
            if (!n.hasOwnProperty(a) || !n[a]) {
              ...
              f || (f = O[s] = d("ON_PROPERTY" + s)),
                (i.set = function (t) {
                  ...
                  e || n !== m || (e = m),
                    e &&
                      (e[f] && e.removeEventListener(s, A),
                      u && u.apply(e, k),
                      "function" == typeof t
                        ? ((e[f] = t), e.addEventListener(s, A, !1))
                        : (e[f] = null));
                }),
                (i.get = function () {
                  var t = this;
        ...
        function W(t, e, r) {
          ...
          function w(e, r) {
            ...
            r && r.prepend && (E = x[d(r.prepend)] = x[r.prepend]);
            var I = a
                ? function (t) {
                    if (!T.isExisting)
                      return (
                    ...
                    if (!c || c(e, d, h, arguments)) {
                      ...
                      if (N)
                        for (var k = 0; k < N.length; k++)
                          if (v === N[k]) return e.apply(this, arguments);
                      var w = !1;
                      void 0 === b
                        ? (y = !1)
                        : !0 === b
                      ...
                      if (D) {
                        if (((L = !0), m))
                          for (k = 0; k < D.length; k++) if (C(D[k], d)) return;
                      } else D = h[x] = [];
                      ...
                      var F = a ? q : void 0;
                      F && (F.taskData = T);
                      var z = E.scheduleEventTask(I, d, F, o, i);
                      return (
                        (T.target = null),
                        F && (F.taskData = null),
                        w && (b.once = !0),
                        (G || "boolean" != typeof z.options) && (z.options = b),
                        (z.target = h),
                        (z.capture = y),
                        (z.eventName = v),
                        g && (z.originalDelegate = d),
                        s ? D.unshift(z) : D.push(z),
                        u ? h : void 0
                      );
                    }
                  }
                  ...
                  if (h)
                    for (var v = 0; v < h.length; v++) {
                      ...
                      if (C(d, a)) {
                        ...
                        return d.zone.cancelTask(d), w ? e : void 0;
                      }
                    }
          ...
          for (var x = [], E = 0; E < e.length; E++) x[E] = w(e[E], r);
          return x;
        }
        function B(t, e) {
          var n = [];
        ...
        function dt(t, e) {
          if ((!S || T) && !Zone[t.symbol("patchEvents")]) {
            var r = "undefined" != typeof WebSocket,
              o = e.__Zone_ignore_on_properties;
            if (_) {
              var i = window,
                a = F ? [{ target: i, ignoreProperties: ["error"] }] : [];
              vt(i, pt.concat(["messageerror"]), o ? o.concat(a) : o, n(i)),
                vt(Document.prototype, pt, o),
                void 0 !== i.SVGElement && vt(i.SVGElement.prototype, pt, o),
                vt(Element.prototype, pt, o),
                vt(HTMLElement.prototype, pt, o),
                vt(HTMLMediaElement.prototype, ot, o),
                vt(HTMLFrameSetElement.prototype, rt.concat(at), o),
                vt(HTMLBodyElement.prototype, rt.concat(at), o),
                vt(HTMLFrameElement.prototype, it, o),
                vt(HTMLIFrameElement.prototype, it, o);
            ...
            f && vt(f && f.prototype, ut, o),
              "undefined" != typeof IDBIndex &&
                (vt(IDBIndex.prototype, st, o),
                vt(IDBRequest.prototype, st, o),
                vt(IDBOpenDBRequest.prototype, st, o),
                vt(IDBDatabase.prototype, st, o),
                vt(IDBTransaction.prototype, st, o),
                vt(IDBCursor.prototype, st, o)),
              r && vt(WebSocket.prototype, ft, o);
          }
        }
        function gt() {
          (J = Zone.__symbol__),
            ...
            (Object.defineProperty = function (t, e, n) {
              ...
              return "prototype" !== e && (n = bt(t, e, n)), kt(t, e, n, r);
            }),
        ...
        function wt(t, e) {
          ...
          for (m = 0; m < p.length; m++)
            for (var w = p[m], x = (o[w] = {}), E = 0; E < r.length; E++) {
              var S;
              x[(S = r[E])] = w + ".addEventListener:" + S;
            }
          var _ = [];
        ...
        Zone.__load_patch("util", function (n, o, u) {
          ...
          (function (t) {
            t[(t.__Zone_symbol_prefix || "__zone_symbol__") + "legacyPatch"] =
              function () {
                var e = t.Zone;
          ...
          (o = C(t, (e += r), function (n) {
            return function (o, i) {
              if ("function" == typeof i[0]) {
                ...
                return (
                  "number" == typeof f ? (a[f] = s) : f && (f[Et] = s),
                  f &&
                    f.ref &&
                    f.unref &&
                  ...
                  E = C(l, "send", function () {
                    return function (t, n) {
                      ...
                      var o = {
                        ...
                        i = v("XMLHttpRequest.send", T, o, _, O);
                      t &&
                        !0 === t[c] &&
                        !o.aborted &&
                        i.state === b &&
