      ...
      (r = function () {
          ...
          Zone.__load_patch("ZoneAwarePromise", function (e, t, n) {
                  ...
                  var n,
                    ...
                    f = function (e) {
                      ...
                      try {
                        e.then(
                          function (e) {
                            (u[n] = t ? t.thenCallback(e) : e),
                              0 == --s && a(u);
                          },
                          function (e) {
                            t
                              ? ((u[n] = t.errorCallback(e)), 0 == --s && a(u))
                              : i(e);
                          }
                        );
                      } catch (r) {
            ...
            (x && !x.configurable) ||
              ...
              (x.set = function (t) {
                t === I
                  ? (e[L] = t)
                  : ((e[s] = t), t.prototype[l] || H(t), n.setNativePromise(t));
              }),
              a(e, "Promise", x)),
              (e.Promise = I);
            var N,
            ...
            if (!n.hasOwnProperty(i) || !n[i]) {
              ...
              u || (u = P[l] = v("ON_PROPERTY" + l)),
                (a.set = function (e) {
                  ...
                  t || n !== _ || (t = _),
                    t &&
                      (t[u] && t.removeEventListener(l, Z),
                      s && s.apply(t, b),
                      "function" == typeof e
                        ? ((t[u] = e), t.addEventListener(l, Z, !1))
                        : (t[u] = null));
                }),
                (a.get = function () {
                  var e = this;
        ...
        function z(e) {
          ...
          if (n) {
            ...
            for (r in n)
              "prototype" !== r && n.hasOwnProperty(r) && (_[e][r] = n[r]);
          }
        }
        var M = !1;
        function I(t, r, o) {
        ...
        function V(e, t, r) {
          ...
          function k(t, r) {
            ...
            var z = i
                ...
                : function (e) {
                    return (
                      C(e), P.call(S.target, S.eventName, e.invoke, S.options)
                    );
                  },
              M = i
                ? function (e) {
                ...
                return (
                  ...
                  function () {
                    ...
                    if (!c || c(t, v, h, arguments)) {
                      ...
                      if (M) {
                        if (((L = !0), _))
                          for (b = 0; b < M.length; b++) if (I(M[b], v)) return;
                      } else M = h[T] = [];
                      ...
                      return (
                        ...
                        F && (F.taskData = null),
                        k && (m.once = !0),
                        (A || "boolean" != typeof H.options) && (H.options = m),
                        (H.target = h),
                        (H.capture = y),
                        (H.eventName = d),
                        g && (H.originalDelegate = v),
                        l ? M.unshift(H) : M.push(H),
                        s ? h : void 0
                      );
                    }
                  }
        ...
        function ve(e, t) {
          if ((!w || S) && !Zone[e.symbol("patchEvents")]) {
            ...
            if (O) {
              ...
              de(a, pe.concat(["messageerror"]), o ? o.concat(i) : o, n(a)),
                de(Document.prototype, pe, o),
                void 0 !== a.SVGElement && de(a.SVGElement.prototype, pe, o),
                de(Element.prototype, pe, o),
                de(HTMLElement.prototype, pe, o),
                de(HTMLMediaElement.prototype, oe, o),
                de(HTMLFrameSetElement.prototype, re.concat(ie), o),
                de(HTMLBodyElement.prototype, re.concat(ie), o),
                de(HTMLFrameElement.prototype, ae, o),
                de(HTMLIFrameElement.prototype, ae, o);
            ...
            u && de(u && u.prototype, se, o),
              "undefined" != typeof IDBIndex &&
                (de(IDBIndex.prototype, le, o),
                de(IDBRequest.prototype, le, o),
                de(IDBOpenDBRequest.prototype, le, o),
                de(IDBDatabase.prototype, le, o),
                de(IDBTransaction.prototype, le, o),
                de(IDBCursor.prototype, le, o)),
              r && de(WebSocket.prototype, ue, o);
          }
        }
        function ge() {
          (Q = Zone.__symbol__),
            ($ = Object[Q("defineProperty")] = Object.defineProperty),
            (ee = Object[Q("getOwnPropertyDescriptor")] =
        ...
        Zone.__load_patch("util", function (n, o, s) {
          ...
          n[d] && (n[l] = n[d]),
            ...
            (s.filterProperties = he),
            (s.attachOriginToPatched = L),
          ...
          (function (e) {
            e[(e.__Zone_symbol_prefix || "__zone_symbol__") + "legacyPatch"] =
              function () {
                var t = e.Zone;
          ...
          (o = I(e, (t += r), function (n) {
            return function (o, a) {
              if ("function" == typeof a[0]) {
                ...
                return (
                  "number" == typeof u ? (i[u] = l) : u && (u[Ee] = l),
                  u &&
                    u.ref &&
                    u.unref &&
        ...
        Zone.__load_patch("legacy", function (e) {
          ...
          Zone.__load_patch("timers", function (e) {
            we(e, "set", "clear", "Timeout"),
              we(e, "set", "clear", "Interval"),
              we(e, "set", "clear", "Immediate");
          }),
          Zone.__load_patch("requestAnimationFrame", function (e) {
            we(e, "request", "cancel", "AnimationFrame"),
              we(e, "mozRequest", "mozCancel", "AnimationFrame"),
              we(e, "webkitRequest", "webkitCancel", "AnimationFrame");
          }),
                  ...
                  if (i.readyState === i.DONE)
                    if (!r.aborted && i[a] && e.state === m) {
                      ...
                      if (n && n.length > 0) {
                        ...
                        (e.invoke = function () {
                          for (
                            var n = i[t.__symbol__("loadfalse")], a = 0;
                            a < n.length;
                            a++
                          )
                            n[a] === e && n.splice(a, 1);
